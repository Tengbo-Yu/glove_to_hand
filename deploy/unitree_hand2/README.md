...
- `wuji-hand2-network.service` adds `192.168.1.100/32` to `eth0` and direct
  `/32` routes only for the factory Hand2 addresses `.110` and `.111`.  The
  pre-existing route for the rest of `192.168.1.0/24` remains unchanged.
